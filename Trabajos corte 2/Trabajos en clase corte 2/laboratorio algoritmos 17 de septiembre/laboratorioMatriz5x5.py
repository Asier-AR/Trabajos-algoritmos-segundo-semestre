...
laberinto = [
    [0, 2, 1, 0, 0],
    [0, 0, 1, 0, 1], #los puntos de acopio estan marcados por el numero 2
    [2, 0, 0, 2, 0], #las calles cerradas y sin salida estan marcadas con el numero 1    
    [0, 1, 1, 0, 2],  #las calles abiertas que no tienen un punto de acopio estan marcadas por el numero 0  
    [0, 0, 2, 0, 0],
]
...
def resolver(f, c, puntosAcopio):
    ...
    camino[f][c] = 0
    return False
inicio=time.perf_counter() #inicia contador invisible para medir el tiempo que le toma a resolver ejecutarse
